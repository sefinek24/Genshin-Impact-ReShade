...
public sealed partial class InjectionMethod : Form
{
	...
	private void InjectionMethod_Load(object sender, EventArgs e)
	{
		...
		comboBox1.SelectedIndex = Run.InjectType switch
		{
			"exe" => 0,
			"cmd" => 1,
		...
		switch (comboBox1.SelectedIndex)
		{
			...
			case 1:
				if (Secret.IsStellaPlusSubscriber)
				{
					...
					MessageBox.Show("""
					                WARNING! SETTING CHANGED TO ONE DIFFERENT FROM THE RECOMMENDED ONE! I HOPE YOU KNOW WHAT YOU'RE DOING!
					                ...
					                !!! THE CREATOR OF THIS SOFTWARE TAKES NO RESPONSIBILITY FOR ANY BANS IN THE GAME. BY USING THIS FUNCTION, YOU ACCEPT THIS RISK !!!
				...
				else
				{
					...
					MessageBox.Show("""
					                Only Stella Mod Plus subscribers have the ability to change the injection method.

					                Subscribe to have full control over what is to be injected using batch files. Remember not to break the game rules and avoid cheating!
