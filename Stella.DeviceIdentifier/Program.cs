...
internal static class Program
{
	...
	{
		Console.WriteLine(
			"WARNING: If someone asks you for hardware identifiers from the list below,\n" +
		...
		Console.WriteLine(
			...
			"pub   rsa4096 2023-10-19 [SC] [expires: 2025-**-**]\n" +
			"      432012BD6823FB93FFF792A0376D883EFE071F0D\n" +
			"uid   [   absolute   ] Sefinek (Neko cat) <contact@sefinek.net>\n" +
			"sub   rsa4096 2023-10-19 [E] [expires: 2025-**-**]"
		);
