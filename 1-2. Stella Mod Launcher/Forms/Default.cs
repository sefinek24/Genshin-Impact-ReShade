...
using StellaModLauncherNET.Models;
using StellaModLauncherNET.Properties;
using StellaModLauncherNET.Scripts;
using StellaModLauncherNET.Scripts.Download;
using StellaModLauncherNET.Scripts.Forms;
using StellaModLauncherNET.Scripts.Forms.MainForm;
using StellaModLauncherNET.Scripts.Patrons;
using Shortcut = StellaModLauncherNET.Scripts.Shortcut;
